...
public class Configuration {
	...
	/* package */static void init() {
		...
		defaultProperty.setProperty("weibo4j.source", Mobile.CONSUMER_KEY);
		...
		defaultProperty.setProperty("weibo4j.http.proxyPort.fallback",
				"http.proxyPort");
		defaultProperty.setProperty("weibo4j.http.connectionTimeout", "2000");
		defaultProperty.setProperty("weibo4j.http.readTimeout", "120000");
		defaultProperty.setProperty("weibo4j.http.retryCount", "0");
